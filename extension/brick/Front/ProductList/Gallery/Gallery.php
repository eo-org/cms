<?php
class Front_ProductList_Gallery extends Class_Brick_Solid_Abstract
{
	...
	public function getCacheId()
	{
		...
		return 'product_listline_gallery_'.$groupId.'_'.$page;
	}
	...
	public function prepare()
	{
		...
		$co->addFilter('groupId', $groupDoc->getId())
			->setFields(array('id', 'name', 'sku', 'label', 'introicon', 'introtext', 'price', 'attributeDetail', 'attachment'))
			->setPage($page)
